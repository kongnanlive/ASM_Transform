...
//                    "addInterceptorToBuilder", "(Ljava/lang/Object;)V", false);
            mv.visitMethodInsn(Opcodes.INVOKESTATIC, "github/leavesczy/asm/okHttp/OkHttpHook", "getInstance", "()Lgithub/leavesczy/asm/okHttp/OkHttpHook;", false);
            mv.visitVarInsn(Opcodes.ALOAD, 0);
            //mv.visitTypeInsn(Opcodes.CHECKCAST, "okhttp3/OkHttpClient");
            mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "github/leavesczy/asm/okHttp/OkHttpHook", "addInterceptor", "(Lokhttp3/OkHttpClient;)V", false);
        }
    }
}